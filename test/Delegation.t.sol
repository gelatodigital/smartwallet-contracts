...
contract DelegationTest is ECDSASignature, Test {
    ...
    function testExecuteOpData() public {
...

        {
            ...
            Delegation.Call[] memory calls = new Delegation.Call[](1);
            calls[0].to = eoa;
            calls[0].data = abi.encodeWithSelector(delegation.addSigner.selector, pubkey);
...

        {
            ...
            bytes memory sig =
                hex"";
    ...
    function testExecuteOpDataRevert() public {
        bytes32 keyHash;
...

        {
            ...
            bytes memory sig =
                hex"";
